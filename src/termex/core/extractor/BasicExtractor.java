...
public abstract class BasicExtractor {
	...
	protected Normalizer normaliser;
	
	public abstract Map<String, Set<String>> extract(Corpus c) throws Exception;
	
	public abstract Map<String, Set<String>> extract(Document d) throws Exception;
	
	public abstract Map<String, Set<String>> extract(String s) throws Exception;
	...
	public static boolean containDigit(String string) {
		char[] chars = string.toCharArray();
		for (char c : chars) {
